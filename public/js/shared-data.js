...
window.SharedData = {
  ...
  translations: {
    en: {
      ...
      'experience-aptiv-description': 'Led radar processing algorithms for Motional\'s Robotaxi, enhancing sensor fusion libraries with Python, C++, and in-house cloud-based toolchains. Led POC development of lane change prediction and ADAS features for BMW and PSA clients. Delivered error-handling APIs with ROS, ensuring ASPICE-compliant solutions.',
    ...
    de: {
      ...
      // Info section (for index page)
      'info-title': 'Info',
      'info-description': 'Senior Algorithm Engineer und Cloud-Computing-Experte @LotusTech, spezialisiert auf AWS Cloud-Infrastruktur, Datenverarbeitungs-Engineering und ADAS-Entwicklung für autonome Fahrsysteme. Als Solution Architect baue ich skalierbare cloud-native Architekturen mit umfassender Erfahrung in AWS-Services (ECS, Lambda, S3, MSK, Redshift), Kubernetes-Orchestrierung und Echtzeit-Datenverarbeitungspipelines. Meine Expertise umfasst verteilte Systeme, KI-Infrastruktur, Daten-Engineering-Toolchains, Compliance-Frameworks (Data Governance, GDPR) und agiles Projektmanagement—alles entscheidend für skalierbare KI- und autonome Fahranwendungen. Leidenschaftlich darin, Geschäftsanforderungen mit technischen Innovationen zu verbinden, liefere ich maßgeschneiderte Cloud-Architekturlösungen, die Effizienz und Skalierbarkeit vorantreiben. Versiert in Python, Java, C++ (ROS) und Cloud-DevOps-Praktiken. Leitete Entwicklung unternehmensweiter Datenplattformen, die täglich Millionen von Sensordatenpunkten verarbeiten und schnelle ADAS-Iterationszyklen durch datengetriebene Workflows und automatisierte ML-Pipelines ermöglichen.',
      ...
      'experience-aptiv-title': 'Senior Algorithm Engineer',
      'experience-aptiv-description': 'Leitete Radarverarbeitungsalgorithmen für Motional\'s Robotaxi, Verbesserung von Sensorfusions-Bibliotheken mit Python, C++ und internen cloud-basierten Toolchains. Leitete POC-Entwicklung von Spurwechselvorhersage und ADAS-Features für BMW- und PSA-Kunden. Bereitstellung von Fehlerbehandlungs-APIs mit ROS, die ASPICE-konforme Lösungen gewährleisten.',
      'experience-groupon-title': 'Software Engineer',
